...
{
	public static final int		CONTROLLER_BATTLEROOM						= 7;
	public static final int		CONTROLLER_HALL								= 6;
	...
	public static final int		ACTION_REGISTER_LOGIC_SERVER				= 2;
	public static final int		ACTION_REGISTER_LOGIC_SERVER_CONFIRM		= 3;
	public static final int		ACTION_REQUEST_LOGIC_SERVER_ROOM			= 4;
	public static final int		ACTION_REQUEST_LOGIC_SERVER_ROOM_CONFIRM	= 5;
	public static final int		ACTION_LOGIC_SERVER_INFO					= 6;
	public static final int		ACTION_CONNECT_LOGIC_SERVER					= 7;
	// SCENE
