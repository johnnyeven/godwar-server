...
public final class EnumProtocol
{
	...
	public static final short	QUICK_START			= ACTION_QUICK_START << 8
															| CONTROLLER_INFO;
	public static final short	INFO_LOGIN			= ACTION_LOGIN << 8
															| CONTROLLER_INFO;
	public static final short	INFO_LOGOUT			= ACTION_LOGOUT << 8
															| CONTROLLER_INFO;
	public static final short	INFO_REGISTER		= ACTION_REGISTER << 8
															| CONTROLLER_INFO;
}
